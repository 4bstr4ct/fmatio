...
namespace fmatio
{
	...
	using CSafeFmatioFormatter = SafeFmatioFormatter<char>;
	using WSafeFmatioFormatter = SafeFmatioFormatter<wchar>;
	...
	template<typename Formatter = SafeFmatioFormatter<char>, typename Pattern, typename... Arguments>
	FMATIO_INLINE BasicString<char> cformat(const Pattern& pattern, Arguments&&... arguments) FMATIO_NOEXCEPT;

	template<typename Formatter = SafeFmatioFormatter<wchar>, typename Pattern, typename... Arguments>
	...
	template<typename Formatter = SafeFmatioFormatter<char>, typename Pattern, typename Stream, typename... Arguments>
	FMATIO_INLINE void cecho(Stream& stream, const Pattern& pattern, Arguments&&... arguments) FMATIO_NOEXCEPT;

	template<typename Formatter = SafeFmatioFormatter<wchar>, typename Pattern, typename Stream, typename... Arguments>
