...
#ifndef FMATIO_INCLUDE_FMATIO_WRITERS_HPP
#define FMATIO_INCLUDE_FMATIO_WRITERS_HPP
...
namespace fmatio
{
	...
	FMATIO_API class BasicFormatWriter
	{
	public:
	...
	FMATIO_API class BasicDynamicWriter : public BasicFormatWriter<typename Container::CharType>
	{
	private:
		Container& container;
...
#include "../../source/fmatio/writers.inl"
